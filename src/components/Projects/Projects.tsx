...
const projects = [
  {
    ...
    description:
      "A very simple e-commerce website built with JavaScript, HTML, and CSS.",
    image: image1,
  ...
  {
    id: 2,
    title: "Buy Mac Book Pro",
    description: "A Simple JavaScript project to buy Mac Book Pro.",
    image: image2,
...
export default function ProjectsPage() {
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-black text-gray-800 dark:text-white px-2 py-12 top-20">
      <div className="px-8">
        <h1 className="text-3xl font-bold mb-8 text-center py-4">
          My Projects
        </h1>
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-md overflow-hidden flex flex-col"
            >
              <Image
                src={project.image}
                alt={project.title}
